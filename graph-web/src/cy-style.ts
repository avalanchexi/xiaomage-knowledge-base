  ...
  return [
    {
      selector: "node",
      style: {
        width: "mapData(degree, 0, 20, 14, 34)",
        height: "mapData(degree, 0, 20, 14, 34)",
        label: "data(label)",
        "font-size": 10,
        color: "#24272b",
        "text-valign": "bottom",
    ...
    ...typeSelectors,
    { selector: "node:selected", style: { "border-color": "#111827", "border-width": 2.4 } },
    { selector: "node.dim", style: { opacity: 0.28 } },
    { selector: "node.hl, node.highlight", style: { "border-color": "#0a84ff", "border-width": 2 } },
    { selector: "node.seed", style: { "border-color": "#111", "border-width": 2.4 } },
    {
      selector: "edge",
      style: {
        width: 1.4,
